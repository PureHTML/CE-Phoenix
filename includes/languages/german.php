...
const JS_ERROR_SUBMITTED = 'Diese Seite wurde bereits bestätigt. Betätigen Sie bitte OK und warten bis der Prozess durchgeführt wurde.';
...
const ENTRY_DATE_OF_BIRTH_ERROR = 'Bitte geben Sie Ihr Geburtsdatum in folgendem Format ein: TT/MM/JJJJ (z.B. 21/05/1970)';
const ENTRY_EMAIL_ADDRESS_ERROR = '';
const ENTRY_EMAIL_ADDRESS_CHECK_ERROR = 'Die eMail Adresse scheint nicht gültig zu sein - bitte korrigieren.';
const ENTRY_EMAIL_ADDRESS_ERROR_EXISTS = 'Die eMail Adresse ist bereits gespeichert - bitte melden Sie sich mit dieser Adresse an oder eröffnen Sie ein neues Konto mit einer anderen Adresse.';
const ENTRY_STREET_ADDRESS_ERROR = '';
const ENTRY_POST_CODE_ERROR = '';
const ENTRY_CITY_ERROR = '';
const ENTRY_STATE_ERROR = '';
const ENTRY_STATE_ERROR_SELECT = 'Bitte wählen Sie ein Bundesland aus der Liste.';
const ENTRY_TELEPHONE_NUMBER_ERROR = '';
const ENTRY_PASSWORD_ERROR = '';
const ENTRY_PASSWORD_ERROR_NOT_MATCHING = 'Beide eingegebenen Passwörter müssen identisch sein.';
const ENTRY_PASSWORD_CURRENT_ERROR = '';
const ENTRY_PASSWORD_NEW_ERROR = '';
const ENTRY_PASSWORD_NEW_ERROR_NOT_MATCHING = 'Die Passwort-Bestätigung muss mit Ihrem neuen Passwort übereinstimmen.';
const TEXT_DISPLAY_NUMBER_OF_PRODUCTS = 'angezeigte Produkte: <b>%d</b> bis <b>%d</b> (von <b>%d</b> insgesamt)';
const TEXT_DISPLAY_NUMBER_OF_ORDERS = 'angezeigte Bestellungen: <b>%d</b> bis <b>%d</b> (von <b>%d</b> insgesamt)';
const TEXT_DISPLAY_NUMBER_OF_REVIEWS = 'angezeigte Meinungen: <b>%d</b> bis <b>%d</b> (von <b>%d</b> insgesamt)';
const TEXT_DISPLAY_NUMBER_OF_PRODUCTS_NEW = 'angezeigte neue Produkte: <b>%d</b> bis <b>%d</b> (von <b>%d</b> insgesamt)';
const TEXT_DISPLAY_NUMBER_OF_SPECIALS = 'angezeigte Angebote <b>%d</b> bis <b>%d</b> (von <b>%d</b> insgesamt)';
const TEXT_GREETING_PERSONAL = 'Schön, dass Sie wieder da sind <span class="greetUser">%s!</span> Möchten Sie die <a href="%s"><u>neuen Produkte</u></a> ansehen?';
const TEXT_GREETING_PERSONAL_RELOGON = '<small>Wenn Sie nicht %s sind, melden Sie sich bitte <a href="%s"><u>hier</u></a> mit Ihrem Kundenkonto an.</small>';
const ERROR_TEP_MAIL = '<font face="Verdana, Arial" size="2" color="#ff0000"><b><small>Fehler:</small> Die eMail kann nicht über den angegebenen SMTP-Server verschickt werden. Bitte kontrollieren Sie die Einstellungen in der php.ini Datei und führen Sie notwendige Korrekturen durch!</b></font>';
const TEXT_CCVAL_ERROR_INVALID_DATE = 'Das "Gültig bis" Datum ist ungültig. Bitte korrigieren Sie Ihre Angaben.';
const TEXT_CCVAL_ERROR_INVALID_NUMBER = 'Die "KreditkarteNummer", die Sie angegeben haben, ist ungültig. Bitte korrigieren Sie Ihre Angaben.';
const TEXT_CCVAL_ERROR_UNKNOWN_CARD = 'Die ersten 4 Ziffern Ihrer Kreditkarte sind: %s. Wenn diese Angaben stimmen, wird dieser Kartentyp leider nicht akzeptiert. Bitte korrigieren Sie Ihre Angaben gegebenfalls.';
