...
?>
const MODULE_HEADER_TAGS_PRODUCT_TITLE_TITLE = 'Artikel Titel';
const MODULE_HEADER_TAGS_PRODUCT_TITLE_DESCRIPTION = 'Artikelbezeichnung im Seitentitel anzeigen';
